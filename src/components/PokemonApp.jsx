    ...
    <>
        ...
        <div>
            ...
            <FormSection>
                ...
                searchPok={searchPok} userPokemon={userPokemon} changeGenPok={changeGenPok}></RenderForm>}
                ...
                {(hideForm && searchState === 4) && <TableSection className='search_five_randos'>
                    ...
                    <RenderForm changeSearchState={changeSearchState} searchState={searchState} fiveRandos={fiveRandos}></RenderForm></TableSection>}
            </FormSection>
        </div>
        {/* search section */}
        ...
        <TableSection className='adopted_pkmn'>
            ...
            {firstTwennyContent && <tr><th>Name</th><th>Image</th><th>Type</th><th>Ability</th><th>Remove</th></tr>} 
